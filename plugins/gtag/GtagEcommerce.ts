...
export default class GtagEcommerce {
    ...
    static MeasuringProductImpressions(
        ...
        products
            ...
            .forEach((product) => {
                ...
                try {
                    const price = PriceHelper.priceProductByCurrency(shop, product, null, currency)
                    products_list.push({
    ...
    static AddingProductToShoppingCart(
        ...
        try {
            const price = PriceHelper.priceProductByCurrency(shop, product, variant, currency)
    ...
    static MeasuringPurchasesBasket(
        basket: Basket
    ) {
        const products_list: {
            name: any; // Name or ID is required.
